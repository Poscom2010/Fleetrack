          ...
          <div className="space-y-2">
            ...
            <div className="border-t border-white/10 pt-2 mt-2">
              ...
              <Link
                to="/profile"
                onClick={() => setIsMenuOpen(false)}
                className="flex items-center gap-3 rounded-2xl px-4 py-3 text-base font-medium bg-white/5 text-slate-200 hover:bg-white/10 hover:text-white transition"
              >
              ...
              {canManageCompanySettings(userProfile) && (
                <Link
                  to="/company/settings"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-3 rounded-2xl px-4 py-3 text-base font-medium bg-white/5 text-slate-200 hover:bg-white/10 hover:text-white transition mt-2"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
